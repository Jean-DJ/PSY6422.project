...
https://jean-dj.github.io/PSY6422.project.JD/ 

The repository for these pages is:

https://github.com/Jean-DJ/PSY6422.project.JD 
...
## Visualise the data
Draw a scatter plot and a line for the degree of linear correlation
...
## summary
Figure, talking ~ lifetime(red) is positively correlated, medication ~ lifetime(blue) is negatively correlated. Both are small.
